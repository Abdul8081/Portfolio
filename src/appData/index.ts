...
export const skillData = [
  ...
  },
  {
    ...
    shortDescription: 'Designing and managing relational databases with efficient queries and indexing.',
  },
  {
    icon: MongoDBIcon,
    title: 'MongoDB Database',
    shortDescription: 'Building scalable NoSQL databases with flexible schemas and high performance.',
  },
  {
    icon: PostmanIcon,
    title: 'Postman API',
    shortDescription: 'Testing, automating, and debugging RESTful APIs for seamless backend integration.',
  },
  ...
  },
  {
    icon: HTMLCSSIcon,
    title: 'HTML & CSS',
    shortDescription: 'Crafting structured web pages and responsive styles for modern UI design.',
  },
  {
    icon: CybersecurityIcon,
    title: 'Cybersecurity & Ethical Hacking',
    shortDescription: 'Securing systems through penetration testing, threat analysis, and vulnerability assessment.',
  },
  {
    icon: ComputerArchitectureIcon,
    title: 'Computer Architecture',
    shortDescription: 'Understanding processors, memory hierarchies, and system-level optimizations.',
  },
  {
  icon: GithubNewIcon,
  title: 'GitHub Expertise',
  shortDescription: 'Proficient in version control, branching strategies, and collaborative software development using GitHub.',
},
...
export const languages = ['En', 'Hi', 'Fr']
