...
const Hero = () => {
  ...
  const role = useRoleSwitcher({ roles: ['FULL STACK DEVELOPER', 'COMPUTER ORGANISATION & ARCHITECTECTS','CYBERSECURITY & ETHICAL HACKER'] })
    ...
    <section className="bg-primary bg-small-glow bg-small-glow-position md:bg-large-glow-position lg:bg-large-glow min-h-[calc(dvh-4rem)] bg-no-repeat">
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-4 px-4 pt-12 pb-10 md:grid-cols-2 lg:p-4">
        <div className="flex min-h-48 flex-col justify-between lg:min-h-56 lg:max-w-[33.75rem]">
          <h1>
            <span className="text-neutral mb-2 block text-3xl font-bold">Hi - I'm Abdul Muid</span>
        ...
        <div className="flex min-h-[18.75rem] items-center justify-center lg:min-h-[35rem]">
          <div className="text-accent relative size-56 sm:size-60 md:size-[20rem] lg:size-[25.75rem]">
            ...
            <Image
              src={HeroImage}
              alt="Abdul Muid - Full Stack Developer"
              fill
              priority
