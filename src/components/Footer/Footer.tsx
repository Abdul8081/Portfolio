      ...
      <div className="relative z-20 grid grid-cols-1 items-start gap-20 md:grid-cols-2 md:gap-12">
        <div>
          <h5 className="mb-8 flex items-center gap-2">
            ...
            <span className="text-neutral text-lg font-medium">Abdul Muid</span>
          </h5>
          <p className="text-tertiary-content">
            A modern portfolio platform built to showcase skills, projects, and expertise, build for developers and tech professionals.
          </p>
        </div>
