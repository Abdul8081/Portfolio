...
interface TiltCardProjectProps {
...
const TiltCardProject: React.FC<TiltCardProjectProps> = ({ children, className = "" }) => {
  ...
  return (
    <div className="perspective-[1200px]">
      <div
        ref={cardRef}
        className={`relative transition-transform duration-300 ease-out transform-style-preserve-3d rounded-xl shadow-lg hover:shadow-2xl border border-neutral-700 ${className}`}
        style={{
...
export default TiltCardProject;
